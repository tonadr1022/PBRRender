...
#pragma clang diagnostic ignored "-Wall"    // Disable all warnings, or specify certain ones
#pragma clang diagnostic ignored "-Wextra"  // If additional warnings are enabled
